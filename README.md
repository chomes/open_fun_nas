...
Users are expected to run on Ubuntu 22.04 with potential support for 24.04 when it comes out.   We will attempt to try and automate this in the future but for now you will need to install the package yourself.
